...
# 導入BaseProcessor接口 (Phase 5: processor_interface is now in the same directory)
from .processor_interface import BaseProcessor, ProcessingResult, ProcessingStatus, create_processing_result
